...
function setupAnimations() {
    ...
    document.querySelectorAll('.section-header, .about-content, .busas-content, .supporters-content, .important-dates-content, .program-content, .call-for-papers-content, .committees-content, .announcement-card, .gallery-item').forEach(element => {
...
const abstractDeadline = new Date('2025-09-05T23:59:59');
